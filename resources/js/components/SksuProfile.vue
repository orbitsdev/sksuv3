...
<template>
        ...
        <div @click="toggle" 
         ...
         <div class="text-2xl  font-extrabold mr-6 text-white px-4" v-if=" $page.props.can.isSboAdviser"> 
          ...
          <div class="relative ml-4 flex-shrink-0">
            ...
            <div v-show="isOpen" class="transition-all ease-in-out absolute -right-2 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
        ...
        >
            <div class="flex items-center justify-center ">
             <w-progress :size="'24'" class=" text-green-900 mr-8" color="green" circle></w-progress>  <p class=""> Signing out .... </p> 
            </div>
        </SkDialog>
</template>
