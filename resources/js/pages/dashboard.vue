...
<div class="min-h-full">
  <header class="bg-gradient-to-r from-green-900 to-green-900 pb-24">
        ...
        <div class="w-full py-5 lg:border-t lg:border-white lg:border-opacity-20">
          <div class="lg:grid lg:grid-cols-3 lg:items-center lg:gap-8">
            ...
            <div class=" lg:col-span-2 lg:block">
              ...
              <DashboardLink :active="true"> School Year </DashboardLink>
              <DashboardLink :active="true"> Account </DashboardLink>
              <DashboardLink :active="true"> Campus Adviser </DashboardLink>
              <DashboardLink :active="true"> Organizations </DashboardLink>
