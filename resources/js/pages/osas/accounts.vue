...
<div>
  ...
  <div class="block">
            ...
            <TableTitle class="py-4"> Accounts</TableTitle>
   <!--
  ...
  <div class="block">
    <div class="border-b border-gray-200">
      <nav class="-mb-px flex space-x-8" aria-label="Tabs">
        ...
        <a href="#" class="border-green-500 text-green-600 group inline-flex items-center py-4 px-1 border-b-2 font-medium text-sm" aria-current="page">
