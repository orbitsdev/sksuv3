  ...
  <adminlayout>
    ...
    >
            ...
            <div class="grid grid-cols-2">
             <Link :href="route('osas.generatecerticate.certificate.index')" class="rounded-tl-lg rounded-tr-lg sm:rounded-tr-none group relative bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-cyan-500">
                <div>
